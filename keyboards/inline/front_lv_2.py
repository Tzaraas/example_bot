...
def kb_3(enter: Union[Message, CallbackQuery]):
    ...
    button_6 = InlineKeyboardButton("Корзина", callback_data="l2_k3_b6")
    button_7 = InlineKeyboardButton("Добавить товар", callback_data="l2_k3_b7")
    button_8 = InlineKeyboardButton("Удалить товар", callback_data="l2_k3_b8")
    ...
    stend = [[button_1, button_2], [button_3, button_4], [button_5], [button_7, button_6, button_8], [button_9], [button_0]]
    keyboard = InlineKeyboardMarkup(stend, row_width=1)
